...
<CardGroup cols={2}>
  <Card title="Tweet Endpoints" icon="palette" href="https://mintlify.com/docs/settings/global">
    Search tweets, get tweet details, and analyze tweet metrics
  </Card>
  <Card title="User Endpoints" icon="code" href="https://mintlify.com/docs/api-playground/openapi">
    Get user profiles, followers, and following lists
  </Card>
  <Card title="Tweet Search" icon="screwdriver-wrench" href="https://mintlify.com/docs/content/components/accordions">
    Advanced search with filters for dates, keywords and more
  </Card>
  <Card title="User Networks" icon="stars" href="https://mintlify.com/customers">
